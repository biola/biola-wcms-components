// We made some changes to this file so don't just blindly update it.
// The main change was adding support for redactor and removing themes
...
JSONEditor.defaults.editors.string = JSONEditor.AbstractEditor.extend({
  ...
  setValue: function(value,initial,from_template) {
    ...
    // If using Redactor, update the WYSIWYG
    if(this.redactor_instance) {
      this.redactor_instance.redactor('code.set', sanitized);
    }
  ...
  afterInputReady: function() {
    ...
    if(this.source_code) {
      ...
      if(this.options.wysiwyg &&
        ...
        window.jQuery && window.jQuery.fn && window.jQuery.fn.redactor
      ) {
        options = $extend({},{
          minHeight: 200,
          toolbarFixed: false,
        ...
        },JSONEditor.plugins.redactor,self.options.redactor_options||{});
  ...
  destroy: function() {
    // If using Redactor, destroy the editor instance
    if(this.redactor_instance) {
      this.redactor_instance.redactor('core.destroy');
    }
    else if(this.epiceditor) {
...
JSONEditor.AbstractTheme = Class.extend({
  ...
  getModal: function() {
    ...
    el.style.boxShadow = '1px 2px 7px rgba(0,0,0,.4)';
...
// I am removing the Foundation Themes because we aren't using those right now
// RH - Aug 31, 2015
...
// I am removing the JQuery UI Themee because we aren't using it right now
// RH - Aug 31, 2015
